...
class SystemController extends Controller
{
    ...
    public function postSettings( Request $request )
    {
        $this->validate($request, [
            ...
            'server_desc' => 'required|min:5',
            'registration_coin' => 'required|min:1',
        ...
        Settings::set( 'server_desc', $request->server_desc );

        Settings::set( 'registration_coin', $request->registration_coin );
        ...
        Settings::set( 'tema_depan', $request->tema_depan );
