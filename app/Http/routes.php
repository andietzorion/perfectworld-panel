...
Route::controller( 'auth', 'Auth\AuthController', [
    ...
    'getLogin'      => 'auth.login',
    'getReset'      => 'auth.reset',
    'getResetpw'    => 'auth.resetpw',
    'getMailview'    => 'auth.mailview',
    'getTest'    => 'auth.test'
]);
...
Route::post( 'account/settings/pin', 'Front\AccountController@postPin' );

/* Character */
Route::get( 'character/select/{role_id}', 'Front\CharacterController@getSelect' );

// Password reset link request routes...
Route::post( 'passwords/email', 'Auth\PasswordController@postEmail' )->name('password.email');
...
/* Home */
Route::get( '/', ['as' => 'home', 'uses' => 'Front\NewsController@getIndex'] );

/* News */
Route::get( '/news', ['as' => 'news.index', 'uses' => 'Front\NewsController@getIndex'] );
Route::get( '/news/post/{post}', ['as' => 'news.post', 'uses' => 'Front\NewsController@detail'] );
Route::get( '/news/author/{author}', ['as' => 'news.author', 'uses' => 'Front\NewsController@author'] );
Route::get( '/news/category/{category}', ['as' => 'news.category', 'uses' => 'Front\NewsController@category'] );
...
/* Guide */
Route::get( '/guide', ['as' => 'guide.index', 'uses' => 'Front\GuidesController@getIndex'] );

/* Download */
Route::get( '/download', ['as' => 'download.index', 'uses' => 'Front\DownloadsController@getIndex'] );
