...
Breadcrumbs::register( 'auth.reset', function( $breadcrumbs )
{
    $breadcrumbs->push( trans( 'Reset Password' ), url( '/' ) );
});
Breadcrumbs::register( 'auth.login', function( $breadcrumbs )
{
    $breadcrumbs->push( trans( 'Login' ), url( '/' ) );
});
Breadcrumbs::register( 'auth.register', function( $breadcrumbs )
{
    $breadcrumbs->push( trans( 'Register' ), url( '/' ) );
});
...
/* Guides */
Breadcrumbs::register( 'guide.index', function( $breadcrumbs )
{
    $breadcrumbs->parent( 'home' );
    $breadcrumbs->push( trans( 'main.apps.guide' ) );
});

/* Downloads */
Breadcrumbs::register( 'download.index', function( $breadcrumbs )
{
    $breadcrumbs->parent( 'home' );
    $breadcrumbs->push( trans( 'main.apps.download' ) );
});

Breadcrumbs::register( 'news.post', function( $breadcrumbs )
{
    $breadcrumbs->parent( 'home' );
    $breadcrumbs->push( trans( 'main.apps.news' ) );
});
...
Breadcrumbs::register( 'admin.news.edit', function( $breadcrumbs, \App\Models\Article $article )
{
    $breadcrumbs->parent( 'admin.news' );
...
Breadcrumbs::register( 'admin.shop.edit', function( $breadcrumbs, \App\Models\ShopItem $item )
{
    $breadcrumbs->parent( 'admin.shop' );
...
Breadcrumbs::register( 'admin.voucher.edit', function( $breadcrumbs, \App\Models\Voucher $voucher )
{
    $breadcrumbs->parent( 'admin.voucher' );
...
Breadcrumbs::register( 'admin.vote.edit', function( $breadcrumbs, \App\Models\VoteSite $site )
{
    $breadcrumbs->parent( 'admin.vote' );
...
Breadcrumbs::register( 'admin.management.gm.edit', function( $breadcrumbs, App\Models\User $user )
{
    $breadcrumbs->parent( 'admin.management' );
