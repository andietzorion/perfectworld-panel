        ...
        <div class="portlet-body form">
            <form action="{{ url( 'admin/system/settings' ) }}" method="post" class="form-horizontal">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group form-md-line-input">
                        <label class="col-md-2 control-label" for="server_desc">{{ trans( 'system.server_desc' ) }}</label>
                        <div class="col-md-9">
                            <input name="server_desc" type="text" class="form-control" id="server_desc" placeholder="{{ trans( 'system.server_desc' ) }}" value="{{ settings( 'server_desc' ) }}">
                            <div class="form-control-focus"> </div>
                        </div>
                    </div>
                    <div class="form-group form-md-line-input">
                        <label class="col-md-2 control-label" for="registration_coin">{{ trans( 'system.registration_coin' ) }}</label>
                        <div class="col-md-9">
                            <input name="registration_coin" type="text" class="form-control" id="registration_coin" placeholder="{{ trans( 'system.registration_coin' ) }}" value="{{ settings( 'registration_coin' ) }}">
                            <span class="help-block">{{ trans( 'system.registration_coin_desc' ) }}</span>
                            <div class="form-control-focus"> </div>
                        </div>
                    </div>
                    <div class="form-group form-md-line-input">
                    ...
                    <div class="form-group form-md-line-input">
                        <label class="col-md-2 control-label" for="tema_depan">Thema Web</label>
                        <div class="col-md-9">
                            <select name="tema_depan" class="form-control" id="tema_depan">
                                @foreach(['default-theme','darkred-theme'] as $r)
                                <option value="{{$r}}" {{ settings( 'tema_depan' ) == $r ? 'selected' : NULL }}>{{$r}}</option>
                                @endforeach
                            </select>
                            <!-- <span class="help-block">{{ trans( 'system.encrypt_type_desc' ) }}</span> -->
                            <div class="form-control-focus"> </div>
