...
return [
    ...
    */
    ...
    'max_title' => [
        'title' => 'Max Title',
        'description' => 'Maxes title attribute for your character.',
        'requirements' => [
            0 => 'logged_out',
            1 => 'level_40'
        ],
        'complete' => 'Your title is now maxed.'
    ],
    'max_meridian' => [
    ...
    'reset_title' => [
        'title' => 'Reset Title',
        'description' => 'Resets the title of your character to zero.',
        'requirements' => [
            0 => 'logged_out'
        ],
        'complete' => 'Your title has been reset.',
    ],
    'reset_exp' => [
