...
return [
    ...
    */
    ...
    'max_title' => [
        'title' => 'Tingkatkan Title',
        'description' => 'Tingkatkan Title karakter Anda dengan cepat sampai maksimal.',
        'requirements' => [
            0 => 'logged_out',
            1 => 'level_40'
        ],
        'complete' => 'Title Anda berhasil ditingkatkan.'
    ],
    'max_meridian' => [
    ...
    'reset_title' => [
        'title' => 'Reset Title',
        'description' => 'Reset title karakter Anda menjadi 0.',
        'requirements' => [
            0 => 'logged_out'
        ],
        'complete' => 'Title pada karakter Anda berhasil direset.',
    ],
    'reset_exp' => [
        'title' => 'Reset Exp',
